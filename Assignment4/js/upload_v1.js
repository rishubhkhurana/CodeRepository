function uploadAndClassifyImageRes(){
    ...
    $.ajax({
        ...
        crossDomain: true,
        method: 'POST',
        url: 'https://xxxx.execute-api.ap-south-1.amazonaws.com/dev/classify',
        data: formData,
        processData: false,
        contentType: false,
...
function alignImage(){
    ...
    $.ajax({
        ...
        crossDomain: true,
        method: 'POST',
        url: 'https://xxxxx.execute-api.ap-south-1.amazonaws.com/dev/align',
        data: formData,
        processData: false,
        contentType: false,
        dataType: 'json',
...
function uploadAndRecognizeFace(){
    var fileInput = document.getElementById('faceRecogFileUpload').files;
    console.log(fileInput);
    if(!fileInput.length){
        return alert('Please choose a file to upload first.')
    }
    ...
    $.ajax({
        ...
        crossDomain: true,
        method: 'POST',
        url: 'https://cma0twy690.execute-api.ap-south-1.amazonaws.com/dev/classify',
        data: formData,
        processData: false,
        contentType: false,
        mimeType: "multipart/form-data"
...
$('#btnFaceRecogUpload').click(uploadAndRecognizeFace)